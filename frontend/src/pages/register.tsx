...
export default function RegisterPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-slate-950 overflow-hidden p-4 select-none">
      ...
      <div className="relative z-10 w-full max-w-md p-8 sm:p-10 bg-white/90 dark:bg-slate-900/90 backdrop-blur-2xl border border-white/20 dark:border-slate-800 rounded-3xl shadow-2xl shadow-purple-500/10 space-y-6 animate-fade-in">
        {/* Header */}
